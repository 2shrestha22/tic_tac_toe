...
class $AssetsAudioSfxGen {
  ...
  /// File path: assets/audio/sfx/draw_o.mp3
  String get drawO => 'assets/audio/sfx/draw_o.mp3';

  /// File path: assets/audio/sfx/draw_x.mp3
  String get drawX => 'assets/audio/sfx/draw_x.mp3';

  /// List of all assets
  List<String> get values => [drawO, drawX];
}
